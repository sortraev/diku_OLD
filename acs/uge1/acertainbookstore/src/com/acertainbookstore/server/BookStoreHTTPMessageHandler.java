...
public class BookStoreHTTPMessageHandler extends AbstractHandler {
	...
	/** The book store. */
	private CertainBookStore myBookStore;
	...
	/**
	 * Rate one or more books.
	 *
	 * @param request
	 *            Should contain a Set<BookRating> of client ratings.
	 * @param response
	 *            Will contain any exceptions thrown; undefined if no
	 *            exceptions thrown.
	 * @throws IOException
	 *            Signals that an I/O exception has occurred.
	 */
	@SuppressWarnings("unchecked")
	private void rateBooks(HttpServletRequest  request,
	...
	/**
	 * Get the `numBooks` highest rated books.
	 *
	 * @param request
	 *            Should contain `numBooks` for myBookStore.getTopRatedBooks(numBooks).
	 * @param response
	 *            Will contain list of the `numBooks` highest rated books,
	 *            or any exceptions thrown.
	 * @throws IOException
	 *            Signals that an I/O exception has occurred.
	 */
	private void getTopRatedBooks(HttpServletRequest  request,
																HttpServletResponse response) throws IOException {
		byte[] serializedRequestContent = getSerializedRequestContent(request);
	...
	/**
	 * Get a list of books in demand.
	 *
	 * @param response
	 *            Will contain list of books in demand.
	 * @throws IOException
	 *             Signals that an I/O exception has occurred.
	 */
