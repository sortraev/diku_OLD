...
public class BookStoreHTTPServer {
	...
	// the main() function has been factored out such that
	// servers can be started from elsewhere, if necessary.
	// TODO: not necessary at the moment; should probably remove this.
