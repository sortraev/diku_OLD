-- my implementation of BoaInterp.hs from assignment 1.
...
apply "print" args = NoneVal <$ output (unwords $ map showVal args) -- unwords necessary in order to format correctly. 
