...
00000000000004a0 <.dynstr>:
 ...
 4ad:	72 63                	jb     512 <_init-0xaee>
 4af:	70 79                	jo     52a <_init-0xad6>
 4b1:	00 70 75             	add    BYTE PTR [rax+0x75],dh
 4b4:	74 73                	je     529 <_init-0xad7>
 4b6:	00 5f 5f             	add    BYTE PTR [rdi+0x5f],bl
 4b9:	73 74                	jae    52f <_init-0xad1>
 4bb:	61                   	(bad)  
...
0000000000000558 <.gnu.version_r>:
 ...
 56a:	69 0d 00 00 03 00 49 	imul   ecx,DWORD PTR [rip+0x30000],0x49        # 30574 <_end+0x2c55c>
 571:	00 00 00 
...
0000000000000588 <.rela.dyn>:
 ...
 5f3:	00 05 00 00 00 00    	add    BYTE PTR [rip+0x0],al        # 5f9 <_init-0xa07>
...
0000000000001070 <strcpy@plt>:
    ...
    1074:	f2 ff 25 45 2f 00 00 	bnd jmp QWORD PTR [rip+0x2f45]        # 3fc0 <strcpy@GLIBC_2.2.5>
    107b:	0f 1f 44 00 00       	nop    DWORD PTR [rax+rax*1+0x0]

0000000000001080 <puts@plt>:
    1080:	f3 0f 1e fa          	endbr64 
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmp QWORD PTR [rip+0x2f3d]        # 3fc8 <puts@GLIBC_2.2.5>
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d 23 01 00 00 	lea    rdi,[rip+0x123]        # 11eb <main>
...
0000000000001189 <exploit_me>:
    ...
    11c6:	74 0c                	je     11d4 <exploit_me+0x4b>
    11c8:	48 8d 3d 35 0e 00 00 	lea    rdi,[rip+0xe35]        # 2004 <_IO_stdin_used+0x4>
    ...
    11e0:	00 00 
    11e2:	74 05                	je     11e9 <exploit_me+0x60>
...
00000000000011eb <main>:
    ...
    120c:	e8 78 ff ff ff       	call   1189 <exploit_me>
...
0000000000002068 <__FRAME_END__-0x124>:
    ...
    2119:	f0 ff                	lock (bad) 
    211b:	ff 2d 00 00 00 00    	jmp    FWORD PTR [rip+0x0]        # 2121 <__GNU_EH_FRAME_HDR+0x109>
