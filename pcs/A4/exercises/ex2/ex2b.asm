...
0000000000000378 <.note.gnu.build-id>:
 ...
 387:	00 8c 6e 2a 03 90 de 	add    BYTE PTR [rsi+rbp*2-0x216ffcd6],cl
 38e:	bf e0 35 d3 16       	mov    edi,0x16d335e0
 393:	28 e0                	sub    al,ah
 395:	25 d0 c0 f2 7e       	and    eax,0x7ef2c0d0
 39a:	28 fa                	sub    dl,bh
...
0000000000001050 <_start>:
    ...
    1068:	48 8d 3d 19 01 00 00 	lea    rdi,[rip+0x119]        # 1188 <main>
...
0000000000001149 <exploit_me>:
    ...
    1155:	c7 45 f0 00 00 00 00 	mov    DWORD PTR [rbp-0x10],0x0
    115c:	48 8b 55 c8          	mov    rdx,QWORD PTR [rbp-0x38]
    1160:	48 8d 45 d0          	lea    rax,[rbp-0x30]
    1164:	48 89 d6             	mov    rsi,rdx
    1167:	48 89 c7             	mov    rdi,rax
    116a:	e8 c1 fe ff ff       	call   1030 <strcpy@plt>
    116f:	8b 45 f0             	mov    eax,DWORD PTR [rbp-0x10]
    1172:	85 c0                	test   eax,eax
    1174:	74 0f                	je     1185 <exploit_me+0x3c>
    1176:	48 8d 05 87 0e 00 00 	lea    rax,[rip+0xe87]        # 2004 <_IO_stdin_used+0x4>
    117d:	48 89 c7             	mov    rdi,rax
    1180:	e8 bb fe ff ff       	call   1040 <puts@plt>
    1185:	90                   	nop
    1186:	c9                   	leave
    1187:	c3                   	ret
...
0000000000001188 <main>:
    ...
    1197:	48 8b 45 f0          	mov    rax,QWORD PTR [rbp-0x10]
    119b:	48 83 c0 08          	add    rax,0x8
    119f:	48 8b 00             	mov    rax,QWORD PTR [rax]
    11a2:	48 89 c7             	mov    rdi,rax
    11a5:	e8 9f ff ff ff       	call   1149 <exploit_me>
...
0000000000002018 <__GNU_EH_FRAME_HDR>:
    ...
    2036:	ff                   	(bad)
    2037:	ff 88 00 00 00 70    	dec    DWORD PTR [rax+0x70000000]
    203d:	f1                   	int1
    203e:	ff                   	(bad)
    203f:	ff                   	.byte 0xff
...
0000000000002048 <.eh_frame>:
    ...
    20a7:	00 a1 f0 ff ff 3f    	add    BYTE PTR [rcx+0x3ffffff0],ah
    ...
    20b9:	7a 0c                	jp     20c7 <__GNU_EH_FRAME_HDR+0xaf>
    20bb:	07                   	(bad)
...
0000000000003de0 <_DYNAMIC>:
    ...
    3e07:	00 b4 11 00 00 00 00 	add    BYTE PTR [rcx+rdx*1+0x0],dh
    3e0e:	00 00                	add    BYTE PTR [rax],al
    3e10:	19 00                	sbb    DWORD PTR [rax],eax
    3e12:	00 00                	add    BYTE PTR [rax],al
    3e14:	00 00                	add    BYTE PTR [rax],al
    3e16:	00 00                	add    BYTE PTR [rax],al
    3e18:	d0 3d 00 00 00 00    	sar    BYTE PTR [rip+0x0],1        # 3e1e <_DYNAMIC+0x3e>
